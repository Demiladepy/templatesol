...
`gh:solana-foundation/templates/kit\nextjs`
...
> Authenticate with Privy (social + embedded Solana wallet) in a Next.js dApp

`privy` `authentication` `solana` `embedded-wallet` `social-login` `framework-kit`
